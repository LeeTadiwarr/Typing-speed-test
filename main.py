...
window.title("Nate's Typing test")
# Images
bg_img = PhotoImage(file="bg_img2.png", height=800, width=800)
button_img = PhotoImage(file="button_img.png")
results_img = PhotoImage(file="results_img.png", height=800, width=800)
# Create Canvas and Background
canvas = Canvas(window, width=800, height=800)
canvas.pack()
background = canvas.create_image(400, 400, image=results_img)
# Text and button items
text = canvas.create_text(400, 300, text="\n    Nate's Typing Test", font=FONT_START, width=600, fill="black")
